...
\begin{itemize}[leftmargin=1.5in]
    ...
    \begin{itemize}
        \item Assisting with development of R-based software.
    \end{itemize}
    \item[Dec 2021–Present] \textbf{Leonard Lab}\\
...
\begin{itemize}[leftmargin=1.5in]
    ...
    \textit{In progress} | Learning and implementing high-throughput bioinformatics workflows for single cell RNA sequencing experiments.
    \item[Spring 2025] \textbf{CSE 587 Advanced Systems and Synthetic Biology}\\
    \textit{In progress} | Learning about research methods and recent developments in synthetic biology.
